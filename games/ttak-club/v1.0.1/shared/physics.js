(function (root, factory) {
  ...
  function step(objects, dt, board) {
    const events = [], walls = board.walls !== false, inset = board.inset || 0;
    ...
    const constrain = o => {
      if (!o.active) return;
      if (walls) {
        if (o.x - o.radius < left) { o.x = left + o.radius; o.vx = Math.abs(o.vx) * RESTITUTION; }
        if (o.x + o.radius > right) { o.x = right - o.radius; o.vx = -Math.abs(o.vx) * RESTITUTION; }
