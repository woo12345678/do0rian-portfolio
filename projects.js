(function (root, factory) {
  ...
  return [
    ...
    },
    {
      id: 'ttak-club',
      title: '딱! 돌판클럽',
      url: 'games/ttak-club/v1.0.3/',
      image: 'assets/projects/ttak-club-home.png',
      kind: 'game',
      platform: 'BROWSER · STATIC SOLO/LOCAL · 119 TESTS',
      summary: '손맛이 다른 7개 모드를 하나의 결정론적 물리·규칙·AI 위에 구축한 한지·먹·나무 감성의 브라우저 돌판 게임 컬렉션. 한국어/English 전환과 쉬운 모드 설명을 지원합니다. This static release supports solo/local play; online rooms require the server build.',
      impact: '7 Modes · Korean/English · Static Single/Local · v1.0.3 · 119/119 Tests PASS',
    ...
    },
    {
      ...
      playUrl: 'games/stitchkeeper/v3.0.0/',
      image: 'assets/projects/stitchkeeper-game.png',
      kind: 'game',
      platform: 'BROWSER · STATIC SINGLE · OFFLINE',
      summary: '12밤·5개 난이도 캠페인에서 3·6·9밤 후 9개 런 빌드 부적 중 3개를 결정론적으로 드래프트하고, 4종 특수 솔기와 Eclipse 압박을 24개 랜덤 기하 안전 패턴 청사진 위에서 엮어 내는 드로잉 점수 게임.',
      impact: '12 Nights · 9 Charms · 4 Seam Types · 16/16 Tests PASS',
    ...
    {
      id: 'playlog',
      title: 'PLAYLOG — 나의 게임 인생',
      url: 'https://woo12345678.github.io/playlog/',
