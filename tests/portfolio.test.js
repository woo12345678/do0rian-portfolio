...
assert(/186 Game DB/.test(playlog.impact), 'PLAYLOG의 검증된 게임 지식 DB 규모를 표시해야 합니다.');
assert(/54 Mobile/.test(playlog.impact), 'PLAYLOG의 모바일 게임 규모를 표시해야 합니다.');
...
assert(/24\/24/.test(playlog.impact), 'PLAYLOG의 통과 테스트 수를 표시해야 합니다.');
