...
assert(/171 Game DB/.test(playlog.impact), 'PLAYLOG의 검증된 게임 지식 DB 규모를 표시해야 합니다.');
assert(/100 Added/.test(playlog.impact), 'PLAYLOG에 추가한 실제 게임 수를 표시해야 합니다.');
...
assert(/23\/23/.test(playlog.impact), 'PLAYLOG의 통과 테스트 수를 표시해야 합니다.');
